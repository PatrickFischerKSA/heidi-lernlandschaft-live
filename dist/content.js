...
const sources = {
  ...
  "trittenplot": {
    "name": "Open Library: Heidi Grows Up, Inhaltsbeschreibung der Romanvorlage",
    "url": "https://openlibrary.org/works/OL182106W/Heidi_grows_up"
  },
  "trittenbbc": {
    "name": "BBC-Fortsetzung 1954: Vorlagen- und Bearbeitungscredits (IMDb)",
    "url": "https://www.imdb.com/title/tt0424139/fullcredits/"
  },
  "bbc59episodes": {
    "name": "Heidi 1959: Episodentitel und Sendereihenfolge (IMDb)",
    "url": "https://www.imdb.com/title/tt1591533/episodes/"
  },
  "musicaltitles": {
    "name": "TheTVDB: Max Liebman Presents, Liedliste zu Heidi (1955)",
    "url": "https://thetvdb.com/series/max-liebman-presents/allseasons/official"
  },
  "giftplot": {
    "name": "IMDb: A Gift for Heidi, ausführliches Handlungsreferat",
    "url": "https://www.imdb.com/title/tt0051656/plotsummary/"
  },
  "giftrt": {
    "name": "Rotten Tomatoes: A Gift for Heidi, redaktionelle Synopsis",
    "url": "https://www.rottentomatoes.com/m/a_gift_for_heidi"
  },
  "visioncatalog": {
    "name": "Vision Video: Sommerkatalog 2011, Great Bible Discovery (6–12)",
    "url": "https://www.visionvideo.com/files/MC11.pdf"
  },
  "lawrenceabstract": {
    "name": "Michael Lawrence: Hindianizing Heidi (Abstract, Adaptation 5/1, 2012)",
    "url": "https://academic.oup.com/adaptation/article-abstract/5/1/102/6836?login=true"
  },
  "citteriointerview": {
...
const films = [
  ...
  },
  {
    ...
    "taskStatus": "Archivzugang ohne redigierte Aufgabe"
  },
  {
    "id": "1954grows",
    "year": "1954",
    ...
    "analysis": "Die spätere Rückkehr soll Wissen und eine Tätigkeit ins Dorf bringen. Damit kann die Ausbildung ausserhalb der Heimat zu deren Zukunft beitragen, statt nur eine belastende Unterbrechung zu sein. Die Analyse betrifft die dokumentierte Romanvorlage. Wie die BBC diese Spannung inszeniert, ist daraus nicht abzulesen.",
    ...
    "scene": "Charles Trittens Fortsetzungsroman: bibliografische Inhaltsbeschreibung der Open Library; BBC-Credits nennen Tritten als Vorlage und Joy Harington als Bearbeiterin. Zeichne den Weg Alp → Internat → Dorf. Schreibe unter den letzten Ort zwei unterschiedliche Verben: «zurückkehren» und «unterrichten». Beschreibe, welche Voraussetzung das Internat für das zweite Verb schaffen kann.",
    "compare": [
  ...
  },
  {
    ...
    "scene": "Dokumentierte Liedtitel des NBC-Musicals: I Got My Way und The Etiquette Song; TheTVDB-Sendungsverzeichnis. Sprich «Ich habe meinen Willen bekommen» zunächst frei, dann im gleichen, streng wiederholten Takt wie drei von dir formulierte Tischregeln für den Sesemann-Haushalt. Notiere, welche Version Eigenwillen hörbar lässt. Dies ist ein eigenes Inszenierungsexperiment, keine Rekonstruktion der Nummern.",
    "compare": [
  ...
  },
  {
    ...
    "scene": "Handlungsreferate zu A Gift for Heidi bei Rotten Tomatoes und IMDb, nicht der kurze eingebettete Filmanfang. Stelle die beiden Hilfsaktionen gegenüber: Peter soll auftreten; das Paar soll aus einer Gefahr gerettet werden. Notiere jeweils, wessen Ziel verfolgt wird und wer in die Entscheidung einwilligen kann.",
    "compare": [
  ...
  },
  {
    ...
    "scene": "Michael Lawrence: Hindianizing Heidi, öffentliches Abstract, letzter Satz über die Arbeit der Kinderdarsteller. Lege zwei Spalten an: Poornima als erzählte Figur und Baby Naaz als Darstellerin. Ordne «eine Rolle einüben», «im Bild spontan wirken» und «als unschuldiges Kind erscheinen» zu; begründe eine mögliche Doppelzuordnung.",
    "compare": [
  ...
  },
  {
    ...
    "scene": "Episodenverzeichnis der BBC-Fassung von 1959: Titel der sechs wöchentlichen Teile. Übertrage die sechs Titel auf eine Linie. Verbinde «Away from Grandfather» mit «Home Again». Kreise danach «Another Grandmother» ein: Hier benennt ein Titel eine neue Beziehung statt eines Ortes.",
    "compare": [
  ...
  },
  {
    ...
    "scene": "DFF-Bild zu Heidi (1965), unten eingeblendet; dazu die DFF-Inhaltsangabe über den anfangs griesgrämigen Grossvater. Decke zunächst Heidis Gesicht und Arme im Bild ab. Beschreibe den verbleibenden Grossvater. Decke sie wieder auf und prüfe, welche deiner Beschreibungen sich allein durch den Körperkontakt verändert.",
    "refs": [
      "fp65"
    ],
    "compare": [
  ...
  },
  {
    ...
    "scene": "Veröffentlichtes NBC/Getty-Motiv mit Jennifer Edwards, unten eingeblendet; Untersuchung dieses Bildes, nicht einer Filmszene. Betrachte zuerst nur die Figur, dann das ganze Bild. Vergleiche den Blick zum betrachtenden Publikum mit der fehlenden Blickbeziehung zu einer zweiten Figur im dargestellten Raum.",
    "refs": [
      "lib68"
    ],
    "compare": [
  ...
  },
  {
    ...
    "analysis": "Versetzter Gesang lässt gemeinsame Anwesenheit und fehlende Übereinstimmung gleichzeitig hörbar werden. Das gemeinsame Schlusswort schafft einen begrenzten Moment der Verbindung. Die Deutung ist in Senenskys rückblickendem Bericht verankert; sie beweist nicht, dass jedes Publikum sie bemerkt.",
    ...
    "scene": "Ralph Senenskys Regiebericht, Abschnitt unmittelbar nach dem fünften eingebetteten Clip: getrennt aufgenommene Gesangspartien und «Amen». Klopfe zwei leicht versetzte Rhythmen und führe sie erst bei einem gemeinsamen Schlusswort zusammen. Übertrage den Unterschied auf Heidis Verhältnis zum Grossvater in der beschriebenen Nummer.",
    "compare": [
  ...
  },
  {
    ...
    "scene": "AFI-Synopse zu Heidi’s Song: Absatz nach der Entdeckung der Kätzchen, Keller und Befreiung. Zeichne die Hilfskette Keller → Eule → Peter und Ziegen → Fenster → gemeinsame Abreise. Streiche probeweise die Eule: An welcher Stelle bricht die Kette, obwohl Peter helfen könnte?",
    "compare": [
  ...
  },
  {
    ...
    "scene": "Vision Video, Sommerkatalog 2011: Abschnitt Great Bible Discovery (6–12), drei Kurzbeschreibungen. Schreibe zuerst eine Programmankündigung für Climb a Tall Mountain allein. Ergänze dann die beiden Nachbarfilme. Markiere das neue gemeinsame Deutungswort, das deine zweite Ankündigung bestimmt.",
    "compare": [
      "Vergebung",
  ...
  },
  {
    ...
    "analysis": "Das Seil verknüpft Heidi mit einer praktischen Tätigkeit, die grosse Vordergrundfigur macht sie zugleich zum Blickzentrum. Peter bleibt als kleineres Element der Alpenwelt sichtbar. Die Komposition kann eine Hierarchie der Wiedererkennung anbieten, ohne die tatsächliche Verteilung von Entscheidungen, Szenen oder Redezeit zu zählen.",
    ...
    "scene": "Covermotiv zum Realfilm mit Emma Bolger und Max von Sydow, unten eingeblendet. Verfolge das Seil von Heidis Händen zur Ziege. Vergleiche diese konkrete Verbindung mit dem Grössenunterschied zwischen Heidi und Peter. Halte Bildposition und Figurenrolle getrennt fest.",
    "refs": [
      "marcus"
    ],
    "compare": [
  ...
  },
  {
    ...
    "scene": "DFF-Inhaltsangabe zum Zeichentrickfilm von Alan Simpson, Abschnitt «Inhalt». Ordne die drei Zustände «unwohl in fremder Umgebung», «Freundschaft mit Peter», «Zuneigung des Grossvaters» auf einer Linie. Schreibe darunter, bei wem jeweils eine Veränderung vorausgesetzt wird.",
    "compare": [
  ...
  },
  {
    ...
    "analysis": "Eine öffentliche Parteinahme verändert auch die Stellung vor der Gruppe. Unter vier Augen kann Heidi Gründe erfragen, ohne die andere Person sofort vor Publikum festzulegen. Das Experiment nutzt die wiederkehrende Schule: Die Beteiligten müssen einander weiterhin begegnen. Eine Lösung muss deshalb mit den Folgen für beide Bindungen rechnen.",
    ...
    "scene": "Produktionsbefund zur Jugendserie Heidi & Co.: Gegenwart, Schule und neue Freundschaften; abgegrenzter eigener Szenenentwurf. Schreibe zwei Äusserungen Heidis im Klassenzimmer: eine öffentlich vor allen, eine spätere unter vier Augen. Lasse beide Beziehungen nach dem Gespräch weiterbestehen; niemand darf einfach wegziehen.",
    "compare": [
  ...
  },
  {
    ...
    "scene": "Studio-100-Werbemotiv zur CGI-Serie, unten eingeblendet: drei Figuren, Apfelkorb und verschneite Strasse. Decke die Figuren ab und beschreibe nur die Strasse. Decke danach den Hintergrund ab und beschreibe die Gruppe. Führe beide Ebenen wieder zusammen: Welche Gegenstände und Gesten verbinden Stadt und Vergnügen?",
    "refs": [
      "cgi"
    ],
    "compare": [
  ...
  },
  {
    ...
    "scene": "Interview mit Autorin Marcela Citterio in Licensing Italia, 20. März 2018: Antwort zu den Unterschieden gegenüber dem Original. Zeichne zwei Wege: Heidi fährt allein in die Stadt; danach folgt Pedro. Trage bei der zweiten Linie ein, welche vertraute Beziehung Heidi nun am neuen Ort weiterführen kann. Entwirf einen Konflikt, der erst durch Pedros Anwesenheit neben neuen Stadtfreundschaften entsteht, und kennzeichne ihn als eigene Möglichkeit.",
    "compare": [
      "Neue soziale Welt",
